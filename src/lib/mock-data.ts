...
export const mockContainers: ContainerSummary[] = [
  { id: "a1b2c3d4e5f6", name: "nginx-proxy", image: "nginx:alpine", composeProject: null, composeService: null, status: "running", state: "Up 3 hours", ports: "0.0.0.0:80->80/tcp, 443/tcp", created: "2026-03-28T10:00:00Z", cpuPercent: 0.12, memUsage: "24.5 MiB", memLimit: "512 MiB", netIO: "1.2 MB / 840 KB", blockIO: "12 MB / 4 KB" },
  { id: "b2c3d4e5f6g7", name: "postgres-db", image: "postgres:16", composeProject: "app-stack", composeService: "postgres", status: "running", state: "Up 2 days", ports: "0.0.0.0:5432->5432/tcp", created: "2026-03-26T08:30:00Z", cpuPercent: 1.45, memUsage: "128 MiB", memLimit: "1 GiB", netIO: "45 MB / 12 MB", blockIO: "890 MB / 234 MB" },
  { id: "c3d4e5f6g7h8", name: "redis-cache", image: "redis:7-alpine", composeProject: "app-stack", composeService: "redis", status: "running", state: "Up 2 days", ports: "0.0.0.0:6379->6379/tcp", created: "2026-03-26T08:30:00Z", cpuPercent: 0.03, memUsage: "8.2 MiB", memLimit: "256 MiB", netIO: "12 MB / 8 MB", blockIO: "2 MB / 512 KB" },
  { id: "d4e5f6g7h8i9", name: "api-server", image: "node:20-slim", composeProject: "app-stack", composeService: "api", status: "running", state: "Up 1 hour", ports: "0.0.0.0:3000->3000/tcp", created: "2026-03-30T07:00:00Z", cpuPercent: 3.21, memUsage: "210 MiB", memLimit: "512 MiB", netIO: "890 KB / 2.1 MB", blockIO: "45 MB / 12 MB" },
  { id: "e5f6g7h8i9j0", name: "worker-queue", image: "python:3.12-slim", composeProject: null, composeService: null, status: "stopped", state: "Exited (0) 5 min ago", ports: "", created: "2026-03-29T15:00:00Z", cpuPercent: 0, memUsage: "0 B", memLimit: "256 MiB", netIO: "0 B / 0 B", blockIO: "0 B / 0 B" },
  { id: "f6g7h8i9j0k1", name: "monitoring", image: "grafana/grafana:latest", composeProject: null, composeService: null, status: "paused", state: "Paused", ports: "0.0.0.0:3001->3000/tcp", created: "2026-03-27T12:00:00Z", cpuPercent: 0, memUsage: "95 MiB", memLimit: "512 MiB", netIO: "23 MB / 5 MB", blockIO: "120 MB / 45 MB" },
];
